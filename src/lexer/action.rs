...
pub struct Action<Kind: 'static, ActionState = (), ErrorType = ()> {
  ...
  // this is optional so that if users want an un-muted action to be executed every time
  // they can set this to None.
...
impl<Kind, ActionState, ErrorType> Action<Kind, ActionState, ErrorType> {
  ...
  /// Muted actions' output won't yield a token unless [`ActionOutput::error`] is [`Some`].
