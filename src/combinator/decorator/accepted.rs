...
///
/// You can't construct this or modify [`Self::instant`] and [`Self::output`] directly.
  ...
  Accepted<&'instant Instant<TextRef>, StateRef, HeapRef, Value>
{
  ...
  /// # Safety
  /// The caller must ensure the output is generated by the instant.
  #[inline]
  pub(super) const unsafe fn new_unchecked(
